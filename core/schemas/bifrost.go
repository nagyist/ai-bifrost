...
const (
	...
	BifrostContextKeyStreamRequest                       BifrostContextKey = "bifrost-prompt-stream-from-version"               // bool (set by prompts HTTP plugin when prompt version model_params.stream is true and body omitted stream)
